...
from .performance.plotter import PerformancePlotter
from .portfolio.manager import PortfolioManager
from .strategy.loader import StrategyType
...
class Mode:
    """
    The base class for different modes (e.g., backtesting, live trading) in the trading framework.
    ...
    Attributes:
        ...
        performance_plotter (PerformancePlotter): An instance of the PerformancePlotter class to handle plotting operations.
    ...
    def __init__(
        ...
        self.performance_plotter = performance_plotter
